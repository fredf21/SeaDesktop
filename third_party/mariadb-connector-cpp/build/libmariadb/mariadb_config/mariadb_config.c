...
#ifdef HAVE_EMBEDDED
#define EMBEDDED_LIBS "-L/home/frederic/QtProjects/SeaDesktop/third_party/mariadb-connector-cpp/install/lib/mariadb/ -lmariadbd -ldl -lm -lssl -lcrypto"
#endif
...
static void mariadb_get_install_location()
{
  ...
  if (!p || !p[0])
  {
    strncpy(installation_dir, "/home/frederic/QtProjects/SeaDesktop/third_party/mariadb-connector-cpp/install", PATH_MAX - 1);
    return;
  }
}
